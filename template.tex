...
$if(colorlinks)$
            ...
            anchorcolor=$if(citecolor)$$citecolor$$else$blue$endif$,
...
$endif$
$if(biblatex)$
\usepackage[backend=bibtex,hyperref=true,backref=false,maxnames=99,style=trad-abbrv,firstinits=true]{biblatex}
$for(bibliography)$
...
$endif$
$endif$
{\small\balance\bibliography{$for(bibliography)$$bibliography$$sep$,$endfor$}}
